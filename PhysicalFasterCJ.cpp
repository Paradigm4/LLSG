...
class LLSG_PhysicalCrossJoin: public PhysicalOperator
{
public:
    LLSG_PhysicalCrossJoin(std::string const& logicalName,
            ...
            std::shared_ptr<Query> query)
    {
        ...
        std::shared_ptr<Array> replicated = llsg::adaptiveReplicate(input1, query, _schema.getResidency());
...
REGISTER_PHYSICAL_OPERATOR_FACTORY(LLSG_PhysicalCrossJoin, "cross_join", "_llsg_cj");
